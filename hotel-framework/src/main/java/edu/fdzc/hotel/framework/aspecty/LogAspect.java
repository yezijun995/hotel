...
import edu.fdzc.hotel.common.enums.BusinessStatus;
import edu.fdzc.hotel.common.enums.HttpMethod;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(edu.fdzc.hotel.common.annotation.Log)")
